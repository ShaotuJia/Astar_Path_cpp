...
public:
	/*
	 * A public variable
	 * the point where the robot starts
	 */
	...
	/*
	 * Setdata() function
	 * This function is to grid map and save information of each Node to dataSet
	 */
	void Setdata(); // grid dataSet according to the map size

	/*
	 * winner() function
	 * This function is to find the Node with minimum F-value in openSet
	 */
